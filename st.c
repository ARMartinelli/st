...
{
	const char* buffer = "kscrollup\n";
	FILE* pFile = fopen("/home/falken/programs/st/debug.log", "a");
	if(pFile==NULL) {
...
copyurl(const Arg *arg) {
	...
	*/
	...
	fprintf(pFile, "before copying\n");
	if (passes < term.row) {
		fprintf(pFile, "during copying\n");
		selstart(col, row, 0);
